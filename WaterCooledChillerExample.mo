...
partial model WaterCooledChillerExample "Primary only chiller plant system with water-side economizer"
  ...
  Buildings.Examples.ChillerPlant.BaseClasses.Controls.TrimAndRespondContinuousTimeApproximation triAndRes
...
equation
  ...
  connect(TCHWEntChi.port_a, wse.port_b2) annotation(
    Line(points = {{218, -10}, {218, -15}, {148, -15}, {148, -14}, {138, -14}, {138, 87}, {126, 87}}, color = {0, 127, 255}, thickness = 0.5));
